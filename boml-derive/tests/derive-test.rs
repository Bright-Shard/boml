...
fn test_derive_struct_named() {
    ...
    assert!(actual.is_ok());
    assert_eq!(Test { foo: 42, bar: "hello".to_string() }, actual.unwrap());
}
...
fn test_derive_lifetimes() {
    ...
    assert!(actual.is_ok());
    assert_eq!(Test { foo: "hello", bar: "world", baz: "!" }, actual.unwrap());
}
...
fn test_derive_generics() {
    ...
    assert!(actual.is_ok());
    assert_eq!(Test { foo: 42, bar: "hello world" }, actual.unwrap());
}
...
fn test_derive_enum() {
    ...
    assert!(actual.is_ok());
    assert_eq!(Test::B{ foo: 69, bar: "hello world" }, actual.unwrap());
